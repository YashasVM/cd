/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 778c644cc3738e26f082eed99111e95d)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 
interface __BaseEnv_Env {
	CONNECTION_RATE_LIMITER: RateLimit;
	PEER_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	TRANSFERS: DurableObjectNamespace<import("./worker/index").TransferRoom>;
	PEERS: DurableObjectNamespace<import("./worker/index").PeerSignal>;
	CODES: DurableObjectNamespace<import("./worker/index").CodeDirectory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "TransferRoom" | "PeerSignal" | "CodeDirectory";
	}
	interface TestEnv {
		CONNECTION_RATE_LIMITER: RateLimit;
		PEER_RATE_LIMITER: RateLimit;
