...
function CliDownload() {
  ...
  return (
    ...
    >
      <div>
        <p className="eyebrow">CD CLI</p>
        <h2 id="cli-download-title">Download CD for {platformLabel}.</h2>
        {platform === "other" && (
      ...
      <div className="cli-download-actions" aria-live="polite">
        {selectedAsset && release ? (
          ...
          <span className="cli-download-primary loading" aria-label="Loading latest CD release">
            <Download aria-hidden="true" />
            <span>
      ...
      <div className="home-blog-heading">
        <div>
          ...
          <p>
            ...
            browsers and terminals meet, plus updates when CD changes.
          </p>
        </div>
  ...
  return (
    <details className="home-reviews">
      ...
      <div className="home-reviews-body">
        <p>Comments from people using CD to move their files.</p>
...
export function App() {
  ...
  useEffect(() => {
    ...
    if (!isStoredShareValue(requestedReceiveValue) && requestedReceiveValue.length < 6) {
      ...
      setReceiveStatus("The CD code in this link is too short");
      return;
    }
    void startReceive();
        ...
        popover: {
          ...
          description: receiveOnly
            ? requestedStoredURL
              ...
              : "This receive link already filled its CD code and started connecting. You only need to review the incoming files and choose where to save them."
    ...
    if (!receiveOnly) {
      steps.push({
        ...
        popover: {
          ...
          description: `Use Direct for a live CD code transfer, or Store for an encrypted link that lasts ${formatStoredExpiration(
            storedExpiration.value,
            storedExpiration.unit,
    ...
    steps.push(
      {
        ...
        popover: {
          ...
          description:
            "Paste the sender’s CD code, encrypted browser link, or CLI token. Review incoming files or text before choosing whether to save, display, or refuse it.",
      ...
      },
      {
        ...
        popover: {
          ...
          description:
            "Direct transfers use password-authenticated key exchange (PAKE) so both peers derive a strong shared key from the CD code. Stored links carry a separate random key after #, which is not sent to the server. File metadata and chunks are encrypted before leaving the browser.",
          side: "bottom",
          align: "start",
        },
      },
      ...
      },
      {
        ...
        popover: {
          title: "Works with the CD CLI",
          description:
            "Direct browser transfers interoperate with the CD command-line client, and stored transfers include a pasteable CLI token. Download the detected build here, or choose another release from GitHub.",
          side: "top",
          align: "start",
        },
      },
            ...
            <div>
              ...
              <p>
                {sendMode === "stored"
                  ...
                  : "Choose several files. Share one CD code."}
              </p>
            </div>
          </div>
        ...
        >
          <div className="panel-heading">
            ...
            <div>
              <h2>Receive</h2>
              <p>
                Enter a CD code or encrypted stored link. Review before saving
                or displaying.
              </p>
            </div>
          </div>
