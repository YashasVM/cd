...
func TestGeneratePropagatesRandomSourceErrors(t *testing.T) {
	...
	require.Error(t, err)
	assert.ErrorContains(t, err, "generate cdx code word 1")
...
func TestParseUsesStableRoomHash(t *testing.T) {
	...
	assert.Equal(
		t,
		"e177bad77df4e924b2bfddaf4eb4a309c694ac8b6a14c5e811f1e4cf90ad7717",
		components.RoomName,
	)
}
...
func roomName(selector string) string {
	digest := sha256.Sum256([]byte(selector + "cdx"))
