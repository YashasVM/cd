// Package publicrelay defines and measures cdx's ordered public relay pool.
package publicrelay
...
// Probe measures one complete cdx ping/pong exchange.
...
// relay completes a successful cdx ping/pong exchange. Outstanding probes are
