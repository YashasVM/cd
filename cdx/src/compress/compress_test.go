...
var fable = []byte(`The Frog and the Cdxodile
...
The frog croaked in surprise and leaped away from the cdxodile. That creature could swallow him whole in a moment without thinking about it! Once he was a satisfied that he was a safe distance away, he answered. "I'm tired of living in swampy waters, and I want to travel to the other side of the river. But if I swim across, the snakes will eat me."

The cdxodile harrumphed in agreement and sat, thinking, for a while. "Well, if you're afraid of the snakes, I could give you a ride across," he suggested.
...
The frog considered his offer. He did want to get to dry ground very badly, and there didn't seem to be any other way across the river. He looked at the cdxodile from his short, squat buggy eyes and wondered about the cdxodile's motives. But if he rode on the tail, the cdx couldn't eat him anyway. And he was right about the snakes--no self-respecting cdxodile would give a meal to the snakes.

"Okay, it sounds like a good plan to me. Turn around so I can hop on your tail."

The cdxodile flopped his tail into the marshy mud and let the frog climb on, then he waddled out to the river. But he couldn't stick his tail into the water as a rudder because the frog was on it -- and if he put his tail in the water, the snakes would eat the frog. They clumsily floated downstream for a ways, until the cdxodile said, "Hop onto my back so I can steer straight with my tail." The frog moved, and the journey smoothed out.

From where he was sitting, the frog couldn't see much except the back of Cdxodile's head. "Why don't you hop up on my head so you can see everything around us?" Cdxodile invited. `)
...
func BenchmarkTransferChunkCompression(b *testing.B) {
	data := bytes.Repeat([]byte("cdx-transfer-data-"), 2048)
	b.ReportAllocs()
