// Package pakekey binds cdx's peer PAKE exchanges to their participants,
...
const (
	// ProtocolVersion is the fail-closed cdx peer PAKE protocol version.
	ProtocolVersion = 2
	...
	identityDomain   = "cdx/spake2/participant/v2"
	transcriptDomain = "cdx/spake2/channel/v2"
)
...
// Identities returns the ordered, implicit participant identities for a cdx
...
// Init initializes the identity-bound PAKE instance for the supplied cdx
// session context.
...
// confirmation tags bound to the exact cdx transcript.
